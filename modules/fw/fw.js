function OnLoad(){
	...
	{
		$('.fw-button-container').forEach(e => e.remove());
	}
	...
	if($("video").length > 0)
	{
		...
		var container = $("video")[0].parentNode;
		...
		{
			while(container.parentElement != null && (container.parentNode.offsetHeight == maxHeight || maxHeight < 10) && (maxDepth > 0))
			{
